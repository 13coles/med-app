            ...
            <form id="distribute" method="post" action="">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"> Baranggay level </h3>
                            ...
                            <?php
                                ...
                                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    echo "<td><input type='checkbox' name='selectedRequests[]' value='{$row['req_number']}'></td>";
                                      // Edit button
                                    echo "<td class='exclude-print'>
                                            <button class='btn btn-block btn-primary btn-xs' onclick='editRequest({$row['req_number']})'>
       ...
       // Check if any requests are selected
        if (selectedRequests.length === 0) {
            Swal.fire({
                icon: 'warning',
                title: 'Warning',
                text: 'Check the box to start distribution. If for edit, ignore this message.',
            });
            return;
        }
...
function editRequest(reqNumber) {
    $.ajax({

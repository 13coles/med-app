                                ...
                                <tbody>
                                  <?php
                                    ...
                                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        echo "<tr>";
                                        echo "<td><input type='checkbox' name='medicalSupplies[]' value='{$row['id']}'></td>";
                                        ...
                                        if ($totalQuantity < $threshold) {
                                            ...
                                            echo "<td><input type='number' name='item_quantity[{$row['id']}]' max='{$totalQuantity}' value='0' required></td>";
                                        } else {
                                            echo "<td><input type='number' name='item_quantity[{$row['id']}]' max='{$totalQuantity}' value='0'></td>";
                                        }
